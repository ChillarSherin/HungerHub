...
//        OrderTotalTV.setText("Total : " + getResources().getString(R.string.indian_rupee_symbol) + orderDatas.getTotalAmount());
//        if (orderDatas.getItems().size() > 0) {
//            MyOrderDetailsRV.setLayoutManager(new LinearLayoutManager(CartOrderDetailsActivity.this, LinearLayoutManager.VERTICAL, false));
                ...
                if (code.equals("200")) {
                    ...
                    if (myDataset.size() > 0) {
                        ...
                        for (int i = 0; i < myDataset.size(); i++) {
                            ...
                            DetailsOrderIDTV.setText(Html.fromHtml(" <font color=#acacac>" + "Order ID " + "</font><br>" + myDataset.get(i).getOrderPurchaseID()));
                            totalTxtView.setText("Total : " + getResources().getString(R.string.indian_rupee_symbol) + myDataset.get(i).getTotalValNoTax());
                            sgstTotal.setText("SGST : " + getResources().getString(R.string.indian_rupee_symbol) + myDataset.get(i).getTotalSGSTPrice());
                            cgstTotal.setText("CGST : " + getResources().getString(R.string.indian_rupee_symbol) + myDataset.get(i).getTotalCGSTPrice());
                            OrderTotalTV.setText("Grand Total : " + getResources().getString(R.string.indian_rupee_symbol) + myDataset.get(i).getTotalAmount());
